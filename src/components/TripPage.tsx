...
type Props={eyebrow:string;title:ReactNode;subtitle:string;pill?:string;days:DayTab[];countdown?:{target:string;label:string};weather?:{base:string;forecast:string;updated:string};footer:string};
