...
const days=[
  {
    ...
    tip:'🍻 Poteo rules · Small food, small drinks, move on. Repeat until someone suggests another bar.',
    items:[
  ...
  },
  {
    ...
    tip:'🍺 Pace yourselves · Friday is the big one. There is no prize for finishing the weekend on Thursday.',
    items:[
      ...
      {time:'17:15 – 19:00',title:'Poteo around Abando',description:'Vermouth, beer or txakoli before dinner. Bilbao tourism describes the city centre as easy to explore on foot between bars.',icon:'🍺',speech:'Poteo around Abando. Vermouth, beer or txakoli before dinner, then see who talks everyone into the next round.'},
  ...
  },
  {
    ...
    tip:'🌊 Donostia · Keep the day flexible. Coast first, pintxos second, drinks whenever the opportunity presents itself.',
    items:[
  ...
  },
  {
    ...
    tip:'🧳 Sunday rules · Hydrate, eat, move slowly and check the flight or train time before ordering anything ambitious.',
    items:[
